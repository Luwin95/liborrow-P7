 ...
 * 
 */
@WebServiceClient(name = "ItemService", targetNamespace = "itemservice.model.generated.webinterface.liborrow.com", wsdlLocation = "http://ben:8080/liborrow-webservice-webapp/ItemService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ITEMSERVICE_QNAME = new QName("itemservice.model.generated.webinterface.liborrow.com", "ItemService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://ben:8080/liborrow-webservice-webapp/ItemService?wsdl");
    ...
    public ItemClient getItemPort() {
        return super.getPort(new QName("itemservice.model.generated.webinterface.liborrow.com", "ItemPort"), ItemClient.class);
    }
    ...
    public ItemClient getItemPort(WebServiceFeature... features) {
        return super.getPort(new QName("itemservice.model.generated.webinterface.liborrow.com", "ItemPort"), ItemClient.class, features);
    }
