 ...
 * 
 */
@WebServiceClient(name = "UserService", targetNamespace = "model.generated.webinterface.liborrow.com", wsdlLocation = "http://192.168.1.24:8080/liborrow-webservice-webapp/UserService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICE_QNAME = new QName("model.generated.webinterface.liborrow.com", "UserService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://192.168.1.24:8080/liborrow-webservice-webapp/UserService?wsdl");
    ...
    public UserClient getUserPort() {
        return super.getPort(new QName("model.generated.webinterface.liborrow.com", "UserPort"), UserClient.class);
    }
    ...
    public UserClient getUserPort(WebServiceFeature... features) {
        return super.getPort(new QName("model.generated.webinterface.liborrow.com", "UserPort"), UserClient.class, features);
    }
