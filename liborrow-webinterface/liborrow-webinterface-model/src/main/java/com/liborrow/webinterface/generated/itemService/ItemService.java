 ...
 * 
 */
@WebServiceClient(name = "ItemService", targetNamespace = "http://services.webservice.liborrow.com/", wsdlLocation = "http://ben:8080/liborrow-webservice-webapp/ItemService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ITEMSERVICE_QNAME = new QName("http://services.webservice.liborrow.com/", "ItemService");
    ...
    public ItemClient getItemPort() {
        return super.getPort(new QName("http://services.webservice.liborrow.com/", "ItemPort"), ItemClient.class);
    }
    ...
    public ItemClient getItemPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services.webservice.liborrow.com/", "ItemPort"), ItemClient.class, features);
    }
