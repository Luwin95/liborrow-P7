 ...
 * 
 */
@WebServiceClient(name = "UserService", targetNamespace = "userservice.model.generated.webinterface.liborrow.com", wsdlLocation = "http://ben:8080/liborrow-webservice-webapp/UserService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICE_QNAME = new QName("userservice.model.generated.webinterface.liborrow.com", "UserService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://ben:8080/liborrow-webservice-webapp/UserService?wsdl");
    ...
    public UserClient getUserPort() {
        return super.getPort(new QName("userservice.model.generated.webinterface.liborrow.com", "UserPort"), UserClient.class);
    }
    ...
    public UserClient getUserPort(WebServiceFeature... features) {
        return super.getPort(new QName("userservice.model.generated.webinterface.liborrow.com", "UserPort"), UserClient.class, features);
    }
