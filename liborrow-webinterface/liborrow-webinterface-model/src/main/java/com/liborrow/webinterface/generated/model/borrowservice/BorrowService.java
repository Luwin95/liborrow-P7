 ...
 * 
 */
@WebServiceClient(name = "BorrowService", targetNamespace = "borrowservice.model.generated.webinterface.liborrow.com", wsdlLocation = "http://ben:8080/liborrow-webservice-webapp/BorrowService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BORROWSERVICE_QNAME = new QName("borrowservice.model.generated.webinterface.liborrow.com", "BorrowService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://ben:8080/liborrow-webservice-webapp/BorrowService?wsdl");
    ...
    public BorrowClient getBorrowPort() {
        return super.getPort(new QName("borrowservice.model.generated.webinterface.liborrow.com", "BorrowPort"), BorrowClient.class);
    }
    ...
    public BorrowClient getBorrowPort(WebServiceFeature... features) {
        return super.getPort(new QName("borrowservice.model.generated.webinterface.liborrow.com", "BorrowPort"), BorrowClient.class, features);
    }
